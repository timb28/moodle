...
/**
 * Library functions for the Academy theme
 *
...
function academy_process_css($css, $theme) {
    ...
    $css = academy_set_regionwidth($css, $regionwidth);
    ...
    $css = academy_set_customcss($css, $customcss);
 ...
 * @return string
 */
function academy_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function academy_set_customcss($css, $customcss) {
