...
/**
 * Strings for component 'theme_academy_au', language 'en'
 *
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Academy Australia</h2><img src="academy/pix/screenshot.jpg" /><h3>Theme Discussion Forum:</h3><p><a href="http://moodle.org/mod/forum/view.php?id=46">http://moodle.org/mod/forum/view.php?id=46</a></p><h3>Theme Credits</h3><p><a href="http://docs.moodle.org/en/Theme_credits">http://docs.moodle.org/en/Theme_credits</a></p><h3>Theme Documentation:</h3><p><a href="http://docs.moodle.org/en/Themes">http://docs.moodle.org/en/Themes</a></p><h3>Report a bug:</h3><p><a href="http://tracker.moodle.org">http://tracker.moodle.org</a></p></div><div class="theme_description"><h2>About</h2><p>Academy is a fluid-width, three-column theme for Moodle 2.0.<h2>Tweaks</h2><p>This theme is built upon both Base and Canvas, two parent themes included in the Moodle core. If you want to modify this theme, we recommend that you first duplicate it then rename it before making your changes. This will prevent your customized theme from being overwritten by future Moodle upgrades, and you\'ll still have the original files if you make a mess. More information on modifying themes can be found in the <a href="http://docs.moodle.org/en/Theme">MoodleDocs</a>.</p><h2>Credits</h2>	<p>This theme was coded and is maintained by Tim Butler at Harcourts International Pty Ltd. He can be contacted by email at academy@harcourts.net. </p><h2>License</h2><p>This, and all other themes included in the Moodle core, are licensed under the <a href="http://www.gnu.org/licenses/gpl.html">GNU General Public License</a>.</div></div>';
$string['configtitle'] = 'Academy Australia Theme settings';
$string['harcourtsoneurl'] = 'Harcourts One Australia URL';
$string['harcourtsoneurldesc'] = 'URL of the Harcourts One Australia server used for authenticating users.';
$string['harcourtsoneprotection'] = 'Harcourts One Protection';
$string['harcourtsoneprotectiondesc'] = 'Whether H1 login is required to access the content.';
$string['coursebacklink'] = 'Back to contents';
$string['customcss'] = 'Custom CSS';
$string['customcssdesc'] = 'Any CSS you enter here will be added to every page allowing your to easily customise this theme.';
$string['sitemenu'] = 'Site Menu';
$string['sitemenudesc'] = 'The content from this textarea will be used as the site navigation menu that appears on every page.';
...
$string['pluginname'] = 'Academy Australia';
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';
$string['region-center'] = 'Center';
$string['region-bottom'] = 'Bottom';
$string['usergreeting'] = '{$a}';
$string['welcome'] = '{$a}'; // ($a = loginhere)
