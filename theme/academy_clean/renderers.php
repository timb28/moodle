...
class theme_academy_clean_core_course_renderer extends core_course_renderer {
     ...
     * 
     * Academy Clean Theme override of course/renderer.php
     *
     * This function calls:
    ...
    public function course_section_cm($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = array()) {
        ...
        /* Use a custom renderer for mod/subcourse activities. */
        if ($mod->modname == "subcourse") {
            return $this->subcourse_renderer($course, $completioninfo, $mod, $sectionreturn, $displayoptions);
        }
    ...
    /**
     * Wraps the div.activityinstance and span.actions tags in a single div.activityheading tag
     * so we can style the Subcourse name, link and completion icon as a single unit.
     * 
     * @param type $course
     ...
     * @return string
     */
    private function subcourse_renderer ($course, $completioninfo, $mod, $sectionreturn, $displayoptions) {
        ...
        foreach ($courses as $key => $course) {
            ...
            if ($course->id > 0) {
                ...
                $html .= $this->output->heading(html_writer::link(
                    ...
                    format_string($course->fullname, true), $attributes) . ' (' . format_string($course->hostname) . ')', 2, 'title');
            }
