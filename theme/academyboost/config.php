...
$THEME->extrascsscallback = 'theme_academyboost_get_extra_scss';
$THEME->prescsscallback = 'theme_academyboost_get_pre_scss';
...
$THEME->scss = function($theme) {
    ...
    return theme_academyboost_get_main_scss_content($theme);
};
