...
Y.namespace('M.core').LockScroll = Y.Base.create('lockScroll', Y.Plugin.Base, [], {
    ...
    enableScrollLock: function(forceOnSmallWindow) {
        ...
        body.setStyle('overflow', 'hidden'); // Academy Patch M#073 Fix lib_yui_scrolllock not preventing
                                             // scrolling when atto_fullscreen plugin is installed
    ...
    disableScrollLock: function(force) {
        if (this.isActive()) {
            ...
            if (force || currentCount === 1) {
                ...
                body.setStyle('overflow', 'inherit'); // Academy Patch M#073 Fix lib_yui_scrolllock not preventing
                                                      // scrolling when atto_fullscreen plugin is installed
            }
