...
function xmldb_gradedtask_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2013021400) {
        // find all courses that contain graded tasks and reset their cache
        ...
        // gradedtask savepoint reached
        upgrade_mod_savepoint(true, 2013021400, 'gradedtask');
    }
