...
$PAGE->set_url("$CFG->wwwroot/login/country_login.php");
...
if (empty($SESSION->wantsurl)) {
    $SESSION->wantsurl = (array_key_exists('HTTP_REFERER',$_SERVER) &&
                          ...
                          strpos($_SERVER["HTTP_REFERER"], $CFG->wwwroot.'/login/country_login.php') !== 0 &&
...
if (isloggedin() and !isguestuser()) {
    ...
    $continue = new single_button(new moodle_url($CFG->wwwroot.'/login/country_login.php', array('cancel'=>1)), get_string('cancel'), 'get');
