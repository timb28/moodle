 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_ha_myoverview extends block_base {

    /**
     * Init.
     */
    public function init() {
        $this->title = get_string('pluginname', 'block_ha_myoverview');
    }
    ...
    public function get_content() {
        ...
        $renderable = new \block_ha_myoverview\output\main($tab);
        $renderer = $this->page->get_renderer('block_ha_myoverview');
