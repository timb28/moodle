...
class main implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $nocoursesurl = $output->image_url('courses', 'block_ha_myoverview')->out();
        $noeventsurl = $output->image_url('activities', 'block_ha_myoverview')->out();

        // Now, set the tab we are going to be viewing.
        $viewingtimeline = false;
        $viewingcourses = false;
        if ($this->tab == BLOCK_HA_MYOVERVIEW_TIMELINE_VIEW) {
