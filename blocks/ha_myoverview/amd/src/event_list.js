 ...
 * given day range.
 *
 * @module     block_ha_myoverview/event_list
...
define(['jquery', 'core/notification', 'core/templates',
        ...
        'block_ha_myoverview/calendar_events_repository'],
    ...
    var TEMPLATES = {
        EVENT_LIST_ITEMS: 'block_ha_myoverview/event-list-items',
        COURSE_EVENT_LIST_ITEMS: 'block_ha_myoverview/course-event-list-items'
    };
