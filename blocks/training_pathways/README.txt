...
* Rename the training_pathways/ folder to the name of your module (eg "widget").
...
all the instances of the string "training_pathways" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/training_pathways/widget/g' {} \;

* Rename the file lang/en/training_pathways.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_training_pathways.php
...
and you should find that this training_pathways has been added to the list of
installed modules.
